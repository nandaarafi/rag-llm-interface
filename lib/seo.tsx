...
export const getSEOTags = ({
  ...
  return {
    ...
    title: title || "Mindscribe",
    // up to 160 characters (how does your app help the user?)
    description: description || "AI Chatbot for Code Generation and Document Creation",
    // some keywords separated by commas. by default it will be your app name
    keywords: keywords || ["Mindscribe", "AI Chatbot", "Code Generation", "Document Creation"],
    applicationName: "Mindscribe",
    // set a base URL prefix for other fields that require a fully qualified URL (.e.g og:image: og:image: 'https://yourdomain.com/share.png' => '/share.png')
    metadataBase: new URL(
      process.env.NODE_ENV === "development"
        ? "http://localhost:3000/"
        : `https://mindscribe.xyz/`
    ),

    openGraph: {
      title: openGraph?.title || "Mindscribe",
      description: openGraph?.description || "AI Chatbot for Code Generation and Document Creation",
      url: openGraph?.url || `https://mindscribe.xyz/`,
      siteName: openGraph?.title || "Mindscribe",
      // If you add an opengraph-image.(jpg|jpeg|png|gif) image to the /app folder, you don't need the code below
      // images: [
      //   {
      //     url: `https://mindscribe.xyz/share.png`,
      //     width: 1200,
      //     height: 660,
      //   },
      // ],
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          name: "Mindscribe",
          description: "AI Chatbot for Code Generation and Document Creation",
          image: `https://mindscribe.xyz/icon.png`,
          url: `https://mindscribe.xyz/`,
          author: {
            "@type": "Person",
            name: "Marc Lou",
          },
